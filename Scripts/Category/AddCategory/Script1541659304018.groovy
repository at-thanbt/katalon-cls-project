...
WebUI.click(findTestObject('Category/AddCategory/button_cancel_category'))
...
WebUI.setText(findTestObject('Category/AddCategory/input_category_name'), 'Chủ đề tạo từ katalon')
...
WebUI.click(findTestObject('Category/AddCategory/choose_higher_category'))

Thread.sleep(2000)

WebUI.setText(findTestObject('Category/AddCategory/input_category_content'), 'Nội dung của chủ đề')
...
WebUI.verifyTextPresent('Chủ đề tạo từ katalon', false)
