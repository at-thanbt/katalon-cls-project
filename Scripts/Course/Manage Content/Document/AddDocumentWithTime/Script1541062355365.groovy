...
WebUI.click(findTestObject('Course/ManageContent/NameContent/content_document'))

Thread.sleep(2000)

WebUI.setText(findTestObject('Course/ManageContent/Document/input_name_document'), 'document with time')
