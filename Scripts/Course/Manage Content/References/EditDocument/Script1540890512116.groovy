...
WebUI.click(findTestObject('Course/ManageContent/References/icon_edit_document'))

Thread.sleep(2000)

WebUI.setText(findTestObject('Course/ManageContent/References/input_document_name_edit'), 'Document 2')
