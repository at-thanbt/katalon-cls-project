...
WebUI.click(findTestObject('Message/ReceiveMessage/button_add_message_send'))
...
WebUI.setText(findTestObject('Message/CreateMessage/input_diachinguoinhan'), 'Khóa học tự động do thân tạo')

Thread.sleep(2000)

WebUI.click(findTestObject('Message/CreateMessage/choose_user'))

Thread.sleep(2000)

WebUI.setText(findTestObject('Message/CreateMessage/title_message'), 'Tin nhắn tạo từ Katalon gửi cho khóa học')
...
WebUI.setText(findTestObject('Message/SendMessage/input_search_message_send'), 'Tin nhắn tạo từ Katalon gửi cho khóa học')
