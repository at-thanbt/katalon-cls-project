...
WebUI.setText(findTestObject('Message/CreateMessage/input_diachinguoinhan'), 'Admin2')
...
WebUI.setText(findTestObject('Message/CreateMessage/title_message'), 'Tin nhắn tạo từ Katalon gửi cho một người dùng')
...
WebUI.setText(findTestObject('Message/SendMessage/input_search_message_send'), 'Tin nhắn tạo từ Katalon gửi cho một người dùng')
