...
WebUI.setText(findTestObject('Message/CreateMessage/input_diachinguoinhan'), 'Cà Mau')
...
WebUI.setText(findTestObject('Message/CreateMessage/title_message'), 'Tin nhắn tạo từ Katalon gửi cho chi nhánh')
...
WebUI.setText(findTestObject('Message/SendMessage/input_search_message_send'), 'Tin nhắn tạo từ Katalon gửi cho chi nhánh')
